...
class Substitution():
    ...
    def evaluate(self) -> str:
        return self.reference_type.evaluate(
            self.value,
            self.regex # I want to pass this conditionally
        )
...
class FileLocation():
    path : str
    subs : dict = field(default_factory=dict) #TODO I want this to be dict(Substitution) but I was getting an error that the object was not itterable.
