...
from pantry.reference_types import LiteralReferenceType, KeyReferenceType, ContentReferenceType, ParameterReferenceType
    ...
    def test_substitutions(self):
        for reference_type, value, expected_resolution in zip(
            [
                ...
                KeyReferenceType(None, {"key1" : {"NestedKey1" : "NestedValue1"}, "key2" : "value2"}),
                ContentReferenceType(None, {"key1" : {"NestedKey1" : "NestedValue1"}, "key2" : "value2"}),
...
class TestDestinationFiles:
    def test_destination_files(self):
        ...
        assert dest.file_content == {"AKeyInTheFile" : "A value in the file", "AnotherKeyInTheFile" : {"UhOh" : "This", "OneIs" : "Nested"}}
